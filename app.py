...
# --- UI Components ---
def login_portal():
    st.markdown("<div style='text-align: center;'><h1>🫀 CVD Risk Prediction Portal</h1><h3>BOUESTI CIS STUDENT GROUP 5 CLINIC</h3></h5>use username as team 5</h5></br></h5>password as bouesti2026</h5></div>", unsafe_allow_html=True)
